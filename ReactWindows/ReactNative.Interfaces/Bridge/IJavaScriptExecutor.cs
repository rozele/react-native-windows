...
namespace ReactNative.Core.Bridge
{
    ...
    public interface IJavaScriptExecutor : IDisposable
    {
        ...
        string CallFunctionReturnFlushedQueue(string moduleName, string methodName, IReadableArray arguments);
        ...
        /// <param name="arguments">The arguments.</param>
        /// <returns>The flushed queue of native operations.</returns>
        string InvokeCallbackAndReturnFlushedQueue(int callbackId, IReadableArray arguments);
        ...
        void SetFlushQueueImmediate(Action<string> flushQueueImmediate);

        /// <summary>
        /// Sets a callback for synchronous native methods.
        /// </summary>
        /// <param name="callSyncHook">The sync hook for native methods.</param>
        void SetCallSyncHook(Func<int, int, IReadableArray, IReadableValue> callSyncHook);
    }
}
